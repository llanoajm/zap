...
| iter4a | v13: +res_cap decoder feat | 0.0988 ✓ | 0.078 | 0.889 | 0.367 ✓ | ~0 | res_cap hurts (conflicting corr) |
| iter4b | ensemble α=0.2 (v9+v11) | **0.0206** ✓ | 0.014 | 0.926 | 0.388 ✓ | ~0 | **BEST cost_gap** no retrain |
